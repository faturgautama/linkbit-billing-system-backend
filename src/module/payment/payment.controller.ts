...
export class PaymentController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Success',
    type: PaymentModel.GetAllPayment,
  })
  async getAll(
    @Query() query: PaymentModel.IPaymentQueryParams,
    @Req() req: Request,
    @Res() res: Response,
  ): Promise<any> {
    try {
  ...
  @ApiResponse({
    status: 200,
    description: 'Success',
    type: PaymentModel.GetByIdPayment,
  })
  async getById(
    @Param('id_payment') id_payment: number,
    @Res() res: Response,
  ): Promise<any> {
    try {
  ...
  @ApiResponse({
    status: 200,
    description: 'Success',
    type: PaymentModel.GetAllPaymentMethod,
  })
  async getAllPaymentMethodForInternal(
    @Req() req: Request,
    @Res() res: Response,
  ): Promise<any> {
    try {
  ...
  async payment(
    @Body() body: PaymentModel.CreatePayment,
    @Res() res: Response,
  ): Promise<any> {
    try {
  ...
  async editPayment(
    @Body() body: PaymentModel.UpdatePayment,
    @Req() req: Request,
    @Res() res: Response,
  ): Promise<any> {
    try {
  ...
  async paymentCash(
    @Body() body: PaymentModel.CreatePaymentCash,
    @Req() req: Request,
    @Res() res: Response,
  ): Promise<any> {
    try {
  ...
  async editPaymentCash(
    @Body() body: PaymentModel.UpdatePaymentCash,
    @Req() req: Request,
    @Res() res: Response,
  ): Promise<any> {
    try {
